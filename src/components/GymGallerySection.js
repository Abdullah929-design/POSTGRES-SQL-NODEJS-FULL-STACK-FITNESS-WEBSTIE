...
// 6 curated Unsplash gym images — uniform 3×2 grid, no blank cells
const GALLERY = [
  {
  ...
  {
    url: 'https://images.unsplash.com/photo-1549060279-7e168fcee0c2?w=800&q=80&auto=format&fit=crop',
    label: 'Power Rack',
  },
];
  ...
  return (
    ...
    >
      ...
      <Box sx={{
        ...
        right: 0,
        p: '20px 24px',
        background: 'linear-gradient(0deg, rgba(12,15,15,0.92) 0%, transparent 100%)',
        display: 'flex',
        alignItems: 'flex-end',
        ...
        <Box sx={{
          ...
          '&::before': { width: '1px', height: '100%', left: '50%', top: 0 },
          '&::after':  { height: '1px', width: '100%', top: '50%', left: 0 },
        }} />
      </Box>
      ...
      <Box sx={{
        ...
        width: hovered ? '48px' : '0px', height: '2px',
        backgroundColor: KINETIC.primary,
        transition: 'width 0.4s ease',
      }} />
      <Box sx={{
        position: 'absolute', top: 0, left: 0,
        width: '2px', height: hovered ? '48px' : '0px',
        backgroundColor: KINETIC.primary,
  ...
  return (
    ...
    >
      ...
      <Box sx={{ maxWidth: '1440px', mx: 'auto', px: { xs: '24px', md: '64px' }, position: 'relative' }}>
        ...
        <Box sx={{
          ...
          <Box>
            ...
            <Typography sx={{
              ...
              lineHeight: 1.0, color: KINETIC.onSurface,
          ...
          <Typography sx={{
            ...
            color: KINETIC.onSurfaceVariant, maxWidth: '360px',
          }}>
        ...
        {/* Uniform 3×2 grid — no spanning, no blank cells */}
        <Box sx={{
          display: 'grid',
          gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr', md: '1fr 1fr 1fr' },
          gridAutoRows: { xs: '240px', md: '300px' },
          gap: '12px',
        }}>
          {GALLERY.map((item, i) => (
            <GalleryCard
